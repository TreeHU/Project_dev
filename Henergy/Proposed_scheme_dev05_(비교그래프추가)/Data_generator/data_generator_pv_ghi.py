...
def add_time_features_no_touch(
    ...
    doy_sin, doy_cos 2개 컬럼만 추가해서 반환.
    """
    ...
    doy = ts.dt.dayofyear / 365.0 #타임스탬프가 해당 연도의 몇 번째 날인지 나타내는 정수 값
...
def parse_args():
    ...
    ap.add_argument("--excel_path", type=str, default="./Project/Henergy/Proposed_scheme_dev05_(비교그래프추가)/Data_generator/Data_input/generated_1hour_data_pv_ghi_clearghi.xlsx",
                    help="입력할 엑셀 경로(.xlsx)")
    ...
    ap.add_argument("--out_path", type=str, default="./Project/Henergy/Proposed_scheme_dev04_(추가시뮬)/Data_generator/Data_output/generated_1hour_data_pv_ghi_clearghi_doy.xlsx",
