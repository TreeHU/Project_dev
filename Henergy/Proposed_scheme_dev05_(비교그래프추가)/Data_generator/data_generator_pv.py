...
def parse_args():
    ...
    ap.add_argument("--out_path", type=str, default="./Project/Henergy/Proposed_scheme/Data_generator/Data_output/generated_15min_pv_data.xlsx",
...
def main():
    ...
    merged = add_time_features(pv_df)
