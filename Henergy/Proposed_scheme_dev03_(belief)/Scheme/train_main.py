...
@dataclass
class Config:
    data_path: str = "./Project/Henergy/Proposed_scheme_dev03_(belief)/Data_generator/Data_output/generated_1hour_data_pv_ghi_clearghi_output_y.xlsx"
...
def parse_args() -> Config:
    ...
    p.add_argument("--data_path", type=str, default="./Project/Henergy/Proposed_scheme_dev03_(belief)/Data_generator/Data_output/generated_1hour_data_pv_ghi_clearghi_output_y.xlsx",
    ...
    p.add_argument("--episodes", type=int, default=20000, help="학습 에피소드 수")
...
def main():
    ...
    # --- 로그 파일 준비 ---
    log_dir = "./Project/Henergy/Proposed_scheme_dev03_(belief)/Logs"
    os.makedirs(log_dir, exist_ok=True)
    log_csv = os.path.join(log_dir, f"train_log_{now_korea.strftime('%Y%m%d_%H%M%S')}.csv")
    logs = []
    fig_dir = "./Project/Henergy/Proposed_scheme_dev03_(belief)/Visualization"
