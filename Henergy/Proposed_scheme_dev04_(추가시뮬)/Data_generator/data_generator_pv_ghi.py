...
def parse_args():
    ...
    ap.add_argument("--excel_path", type=str, default="./Project/Henergy/Proposed_scheme_dev04_(추가시뮬)/Data_generator/Data_input/generated_1hour_data_pv_ghi_clearghi.xlsx",
                    help="입력할 엑셀 경로(.xlsx)")
